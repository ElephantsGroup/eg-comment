...
class LastComments extends Widget
{
	...
	public function init()
	{
		...
		if(isset($module->last_comment['number']))
			$this->number = $module->last_comment['number'];
		if(isset($module->last_comment['enabled_name']))
			$this->enabled_name = $module->last_comment['enabled_name'];
		if(isset($module->last_comment['enabled_subject']))
			$this->enabled_subject = $module->last_comment['enabled_subject'];
		if(isset($module->last_comment['enabled_description']))
			$this->enabled_description = $module->last_comment['enabled_description'];
	}
